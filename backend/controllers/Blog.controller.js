...
const Create=async(req,res)=>{
    try{
      ...
      const imagePath = req.file ? req.file.filename : null;
        ...
        return res.status(200).json({success:true,meassage:"Post Created Successfully",post:CreateBlog})
...
const update=async(req,res)=>{
    try {
        ...
        return res.status(200).json({success:true,message:"Post udated successfully",post:postUpdate})
